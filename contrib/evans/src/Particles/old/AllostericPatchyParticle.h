...
struct AllostericPatch  : public BaseParticle {
 ...
 bool flipped;
    ...
    AllostericPatch(LR_vector _a1_xyz, LR_vector _a2_xyz, LR_vector _position, int _id, int _color,
                    bool _active, std::string _allostery_conditional, bool _activation_reversible) :
