...
#include "../../Particles/old/PatchyShapeParticle.h"
...
namespace Legacy {
    ...
    public:
        ...
        number _exc_vol_interaction(BaseParticle<number> *p, BaseParticle<number> *q, LR_vector<number> *r,
                                    bool update_forces);

        number _repulsive_lj(const LR_vector<number> &r, LR_vector<number> &force, number sigma, number rstar, number b,
                             number rc, bool update_forces);

        number
        _repulsive_lj_n(const LR_vector<number> &r, LR_vector<number> &force, number sigma, number rstar, number b,
                        number rc, int n, bool update_forces);

        number _exc_LJ_vol_interaction_sphere(BaseParticle<number> *p, BaseParticle<number> *q, LR_vector<number> *r,
                                              bool update_forces);

        number _exc_vol_hard_icosahedron(BaseParticle<number> *p, BaseParticle<number> *q, LR_vector<number> *r,
                                         bool update_forces);
        ...
        inline number
        _patchy_interaction_notorsion(BaseParticle<number> *p, BaseParticle<number> *q, LR_vector<number> *r,
                                      bool update_forces);

        inline number _patchy_interaction_kf(BaseParticle<number> *p, BaseParticle<number> *q, LR_vector<number> *r,
                                             bool update_forces);

        virtual bool multipatch_allowed(void) { return !this->_no_multipatch; }

        //true if particles of of this type can interact
        bool can_interact(BaseParticle<number> *p, BaseParticle<number> *q) {
            return (bool) this->_interaction_table_types[p->type * _N_particle_types + q->type];
        }
        ...
        virtual number
        just_two_patch_interaction(PatchyShapeParticle<number> *p, PatchyShapeParticle<number> *q, int pi, int qi,
                                   LR_vector<number> *r);

        number get_patch_cutoff_energy() { return this->_lock_cutoff; }

        Patch<number>
        _process_patch_type(std::string input_string); //this function processes patch type from the input file
    ...
    public:
        ...
        virtual number pair_interaction(BaseParticle<number> *p, BaseParticle<number> *q, LR_vector<number> *r = NULL,
                                        bool update_forces = false);

        virtual number
        pair_interaction_bonded(BaseParticle<number> *p, BaseParticle<number> *q, LR_vector<number> *r = NULL,
                                bool update_forces = false);

        virtual number
        pair_interaction_nonbonded(BaseParticle<number> *p, BaseParticle<number> *q, LR_vector<number> *r = NULL,
                                   bool update_forces = false);

        virtual number
        pair_interaction_term(int name, BaseParticle<number> *p, BaseParticle<number> *q, LR_vector<number> *r = NULL,
                              bool update_forces = false) {
